    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <button className="btn btn-accent btn-xs lg:btn-sm w-fit normal-case">
            <MailIcon className="w-4" />
            painbrtt@contact.com.br
          </button>
          <button className="btn btn-accent btn-sm hidden lg:block py-1">
            <img src={leagueLogo} alt="Logo" className="h-full"/>
          </button>
          <button className="btn btn-primary btn-sm hidden lg:block py-1">
